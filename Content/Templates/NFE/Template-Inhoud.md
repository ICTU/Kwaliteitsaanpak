...
| Nr.  | Eis   | Rationale   | Realisatie door | Verificatie   |
|:-----|:------|:------------|:----------------|:--------------|
| 1    | Voldoen aan de BIO- en SSD-maatregelen ten aanzien van informatiebeveiliging | BIO en SSD bevatten een aantal maatregelen ten aanzien van software en/of de infrastructurele componenten waar de software gebruik van maakt. Zie de bijlage [BIO- en SSD-maatregelen](#bio-en-ssd-maatregelen). | ICTU | {penetratietest en/of een secure code review}, te organiseren door {ICTU of opdrachtgever} |
