...
{Geef hieronder alleen de testsoorten weer die door het project worden uitgevoerd.
Zie het kwaliteitsplan voor normen wat betreft de dekking van de verschillende testsoorten.}
...
Dit hoofdstuk beschrijft de interne en de externe rapportagestructuur.

## Interne testrapportages

{Benoem hier de interne testrapportages die voor het project van toepassing zijn.}

De resultaten van de testuitvoer worden gedeeld met de projectleider. De testresultaten zijn te onderdeel van de volgende producten:
