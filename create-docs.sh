...
node node_modules/.bin/markdown-toc --maxdepth=2 --no-firsth1 ICTU-Kwaliteitsaanpak-ISR.md | grep -v -e "#inhoudsopgave" -e "#wijzigingsgeschiedenis" -e "#algemeen" -e "#ictu-specifiek" > ./Generated/ISR/TOC.md
node node_modules/markdown-include/bin/cli.js ./DocumentDefinitions/ISR/document.json
