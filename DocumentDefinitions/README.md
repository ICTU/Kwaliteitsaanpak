...
- `Subtitle`: de subtitel van het document. De tekst `{het project}` staat tussen accolades zodat het in het document geel gearceerd wordt.
...
- `FrontPage`: welke voorpagina moet het document krijgen. Mogelijk waardes zijn `ICTU` en `Neutral`.
...
Voor elke outputformaat moet worden opgegeven:
